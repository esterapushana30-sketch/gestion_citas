    ...
    <div className="dependency-dashboard">
      ...
      >
        ...
        <div className="dependency-info" style={{ flex: 1 }}>
          <h1>{config.name}</h1>
          <p>Gestión de citas para enfermería</p>
        </div>
        ...
        <div className="modal-overlay" onClick={() => setShowAvailability(false)}>
          ...
          >
            <div className="modal-header">
              <h3>
                <Clock size={20} />
                Gestionar Disponibilidad (Enfermería)
              </h3>
            ...
            <div className="modal-body">
              <p>
                Configura tu horario de atención de enfermería para cada día de la semana.
              </p>
        ...
        <div className="modal-overlay" onClick={() => setShowHistory(false)}>
          ...
          >
            <div className="modal-header">
              <h3>
                <History size={20} />
                Historial de Atención (Enfermería)
              </h3>
